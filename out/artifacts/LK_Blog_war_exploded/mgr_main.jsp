    ...
    <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-3">
            <div class="am-input-group am-input-group-sm">
                <input type="text" class="am-form-field" id="input_search" value="<s:property value="#parameters.content"/>">
...
<script>
    ...
    $("#page").paging({
        ...
        */
        ...
        callback: function(num) {
            ...
            $(window).attr('location','${pageContext.request.contextPath}/article_pageList.action?currentPage='+num+'&content='+content);
            // alert(num);
        }
    });
    ...
    $("#add").click(function () {
        ...
        <%--$(window).attr('location','${ctx }/location_mgr_add_article.action');--%>
    });
